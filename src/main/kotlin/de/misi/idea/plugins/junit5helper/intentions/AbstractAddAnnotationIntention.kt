...
abstract class AbstractAddAnnotationIntention(private val annotation: String, private val name: String) : PsiElementBaseIntentionAction(), IntentionAction {
    ...
    private fun getCreateableAnnotation() = "@$annotation(\"\")"
